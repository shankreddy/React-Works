var RadioOtherOption = React.createClass({displayName: "RadioOtherOption",
	...
	render:function(){
		return(React.createElement("p", {className: "form-group radio"}, 
			React.createElement("label", null, 
				React.createElement("input", {ref: "input", onChange: this.onChange, type: "radio", name: this.props.name, value: "other"}), "Other  " 
			), 
			this.state.checked &&(
